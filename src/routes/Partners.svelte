    ...
    >
      <div class="grid gap-4">
        ...
        <p class="w-full max-w-lg">
          El éxito de nuestros clientes es nuestra mayor satisfacción. Nos
          esforzamos por superar sus expectativas y brindar soluciones
          excepcionales.
        </p>
      </div>
      ...
      >
        ...
        <div class="p-4 bg-amber-300 shadow-md dark:shadow-xl rounded-md">
          <img
            src="https://www.svgrepo.com/show/227477/browser-ui.svg"
            alt="Partner"
            class="h-16 w-16"
          />
        </div>
